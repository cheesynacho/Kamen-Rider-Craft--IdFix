...
{  
    ...
    public static final int HELHEIM_DIM_ID = 20;
    ...
    public static final int SANDSOFTIME_DIM_ID = 21;
    ...
    public static final int NORTHERN_BASE_DIM_ID = 22;
    ...
    public static final int RABBIT_HUTCH_DIM_ID = 23;
